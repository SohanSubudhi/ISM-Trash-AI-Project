...
def create_array():
    directory =  os.path.join(os.getcwd(), "src/images")
    images = []
    image_names = []
...
def main():
    ...
    with tab1:
        ...
        if image is not None:
            ...
            for box in detections:
                ...
                font = ImageFont.truetype("src/OpenSans-Regular.ttf", 25)
    ...
    with tab3:
        ...
        st.markdown('Email: <a href="mailto:subudhi.sohan@gmail.com">subudhi.sohan@gmail.com</a>', unsafe_allow_html=True)
        st.markdown('Digital Portfolio: [sohansubudhi.wixsite.com/home](sohansubudhi.wixsite.com/home)')
        st.markdown('LinkedIn: [www.linkedin.com/in/sohan-subudhi](www.linkedin.com/in/sohan-subudhi)')
